    ...
    <div className="p-5 pb-10">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 text-center">
          ...
          <p className="text-xs text-yellow-600 mt-0.5">Pendientes</p>
        </div>
        <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
          <p className="text-2xl font-bold text-green-700">{completed.length}</p>
          <p className="text-xs text-green-600 mt-0.5">Completadas</p>
        </div>
      </div>
                ...
                {task.countRecord && (
                  <div className="mt-3 pt-3 border-t border-gray-100 grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="text-xs text-gray-500">{new Date(task.countRecord.countedAt).toLocaleString("es")}</p>
                    </div>
                  </div>
                )}
              </div>
      ...
      {tasks.length === 0 && (
        <div className="text-center py-16 text-gray-400">
          ...
          <p className="text-sm">No hay tareas asignadas a esta tienda.</p>
        </div>
      )}
    </div>
  );
